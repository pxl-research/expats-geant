...
class AuditLogger:
    ...
    def generate_report(
        ...
        summary = {
            ...
            "suggestions_generated": sum(1 for e in entries if e.event_type == AuditEventType.SUGGEST),
            "suggestions_edited": sum(1 for e in entries if e.event_type == AuditEventType.EDIT_SUGGESTION),
        }
