...
class Citation(BaseModel):
    ...
    position_start: int | None = Field(
        None, description="Character position where cited content starts"
    )
    position_end: int | None = Field(
        None, description="Character position where cited content ends"
    )
    position_percentage: float | None = Field(
