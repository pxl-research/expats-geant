...
def build_system_prompt(draft, profile: dict) -> str:
    ...
    return (
        ...
        "- add_section / update_section / delete_section / move_section: manage sections.\n"
        "- add_question / update_question / delete_question / move_question: manage questions.\n"
        "Guidance:\n"
        "- Prefer the smallest mutation that achieves the change; patch only the fields that change.\n"
        "- Ordering is list position, not a field: to reorder, call move_question or move_section "
        "(omit after_id to move to the front); move_question also moves a question across sections.\n"
