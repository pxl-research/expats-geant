...
class TestRetryLogic:
    ...
    def test_rate_limit_exhausts_retries(self):
        ...
        with patch.object(client.chat.completions, 'create') as mock_create:
            ...
            mock_create.side_effect = RateLimitError("Rate limit", response=MagicMock(status_code=429), body=None)
...
class TestStreamingCompletion:
    ...
    def test_streaming_completion_success(self):
        ...
        with patch.object(client.chat.completions, 'create', return_value=mock_stream) as mock_create:
