...
class TestAnswerOption:
    ...
    def test_answer_option_with_metadata(self):
        ...
        option = AnswerOption(
            id="opt_1", text="Yes", value=1, metadata={"color": "green", "icon": "check"}
        )
...
class TestQuestion:
    ...
    def test_create_open_ended_question(self):
        ...
        q = Question(id="q3", text="Please explain your answer", type=QuestionType.OPEN_ENDED)
...
class TestSurvey:
    ...
    def test_survey_serialization(self):
        ...
        survey = Survey(id="survey_1", title="Test Survey", sections=[])
...
class TestResponse:
    ...
    def test_create_response(self):
        ...
        response = Response(
            id="resp_1", question_id="q1", answer_value="Very satisfied", session_id="sess_123"
        )
    ...
    def test_response_with_list_answer(self):
        ...
        response = Response(id="resp_2", question_id="q2", answer_value=["opt_1", "opt_3", "opt_5"])
    ...
    def test_response_with_numeric_answer(self):
        ...
        response = Response(id="resp_3", question_id="q3", answer_value=75)
            ...
            sections=[
                Section(
                    ...
                    questions=[
                        ...
                        Question(id="q2", text="Any comments?", type=QuestionType.OPEN_ENDED),
                    ],
                )
            ],
        )
