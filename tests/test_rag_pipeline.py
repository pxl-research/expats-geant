...
def test_suggest_answer_generation_failure(rag_pipeline, mock_session_manager, mock_llm_client, sample_chunks):
...
def test_suggest_answer_with_custom_params(rag_pipeline, mock_session_manager, mock_llm_client, sample_chunks):
